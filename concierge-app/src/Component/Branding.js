      ...
      {/* height='183em' */}
          {/* height='183.8em' */}
           ...
           <TweenOne animation={ this.anim2.img_1} >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 333 333' style={{ marginLeft: '-42px',marginTop: '10px'}}>
            ...
            <TweenOne animation={this.anim2.img_2} >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 333 333' style={{ marginLeft: '-50px', marginTop: '6px'}}>
            ...
            <TweenOne animation={this.anim2.img_3}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 333 333' style={{ marginLeft: '-56.69px', marginTop: '4px'}}>
            ...
            <TweenOne animation={this.anim2.img_4}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 333 333'style={{ marginLeft: '-64px', marginTop: '3px'}}>
