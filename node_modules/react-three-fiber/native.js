...
import { createContext, useState, useRef, useMemo, useLayoutEffect, useCallback, useEffect, createElement, useContext, memo } from 'react';
...
const useCanvas = props => {
  ...
  }, [defaultCam, size, updateDefaultCamera]); // Only trigger the context provider when necessary
...
export { Canvas, Renderer, addEffect, applyProps, createPortal, extend, invalidate, render, renderGl, unmountComponentAtNode, useCamera, useFrame, useLoader, useRender, useResource, useThree, useUpdate };
